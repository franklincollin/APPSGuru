...
int main(int argc, char *argv[])
{
    ...
    //4
    QObject::connect(&httplogin, SIGNAL(sendHTTPResponse(QVariant, QVariant, QVariant, QVariant, QVariant, QVariant, QVariant)),
                     item, SLOT(receiveHTTPResponse(QVariant, QVariant, QVariant, QVariant, QVariant, QVariant, QVariant)));
    //5
