...
Rectangle {
    ...
    objectName: "updatePunishmentData"
    ...
    signal trigerUpdateData0(string arg0, string arg1, string arg2, string arg3)
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            MouseArea{
                ...
                onClicked: {
                    updateDataLayoutStackView.push(updateAppreciationDataView)
                }
            }
        }
    }
 ...
 EditableStudentDescription{
     ...
     onButtonClicked: {
         ...
         console.log("completeInformation: " + completeInformation)

         trigerUpdateData0(dataId, nis, dataID, completeInformation)
     }
 }
