...
Rectangle {
    ...
    objectName: "deleteDataLayout1"

    property string dataId1
    property string studentName1
    property string dateTimeLog1
    property string pointValue1
    property string completeInformation1

    signal trigerStudentListing01(string triger0)
    signal trigerStudentDescription01(string arg0)
    signal trigerDeleteData01(string arg0)
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            MouseArea{
                ...
                onClicked: {
                    mainView.pop(deleteAppreciation)
                }
            }
        }
    }
     ...
     Rectangle {
         ...
         MouseArea {
             ...
             onClicked: {
                 ...
                 trigerStudentDescription01(studentName.text)
                 dataId1 = modelData.dataID
             }
         }
     }
 }
 ...
 Rectangle {
     ...
     Rectangle {
         ...
         MouseArea {
             ...
             onClicked: {
                 //myModel.clear()
                 trigerStudentListing01(studentInput.text)
     ...
     Rectangle {
          ...
          MouseArea {
              ...
              onReleased: {
                  ...
                  console.log("Data yang akan dihapus: " + dataId1)
 ...
 InternetWarningDialog{
     objectName: "internetWarningDialog1"
     anchors.centerIn: parent
 }

 EmptyDataWarning{
     objectName: "emptyDataWarning1"
     anchors.centerIn: parent
 }
 ...
 AppreciatedStudentDescription{
     id: appreciatedStudentDescription
     objectName: "appreciatedStudentDescription"
 }
