...
Rectangle {
    ...
    onWidthChanged: {
        studentNameContainer.text = studentName1
        dateTimeContainer.text = dateTimeLog1
        pointContainer.text = pointValue1
        informationContainer.text = completeInformation1
    }
}
